            ...
            <div class="col-md-6">
                <div class="product-detail mt-6 mt-md-0">
                    ...
                    <div class="price">
                        ...
                        @if ($product->has_sale_price_label)
                            <span class="active-price text-dark">IDR1 {{ $product->sale_price_label }}</span>
                        ...
                        @else
                            <span class="active-price text-dark">IDR2 {{ $product->price_label }}</span>
