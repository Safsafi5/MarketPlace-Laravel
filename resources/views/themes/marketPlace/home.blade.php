@extends('themes.marketPlace.layouts.app')
    @include('themes.marketPlace.shared.slider')
        ...
        <div class="row mt-5">
          <div class="col-lg-3 col-6">
            <div class="card card-product card-body p-lg-4 p3">
              <a href="product.html"><img src="{{asset('themes/marketPlace/assets/img/shop_01.jpg')}}" alt="" class="img-fluid"></a>
          ...
          <div class="col-lg-3 col-6">
            <div class="card card-product card-body p-lg-4 p3">
              <a href="product.html"><img src="{{asset('themes/marketPlace/assets/img/shop_02.jpg')}}" alt="" class="img-fluid"></a>
          ...
          <div class="col-lg-3 col-6 mt-3 mt-lg-0">
            <div class="card card-product card-body p-lg-4 p3">
              <a href="product.html"><img src="{{asset('themes/marketPlace/assets/img/shop_03.jpg')}}" alt="" class="img-fluid"></a>
          ...
          <div class="col-lg-3 col-6 mt-3 mt-lg-0">
            <div class="card card-product card-body p-lg-4 p3">
              <a href="#"><img src="{{asset('themes/marketPlace/assets/img/shop_04.jpg')}}" alt="" class="img-fluid"></a>
    ...
    <section class="latest">
      <div class="container">
        ...
        <div class="row mt-5">
          ...
          <div class="col-lg-3 col-6 mt-3 mt-lg-0">
            <div class="card card-product card-body p-lg-4 p3">
              <a href="product.html"><img src="{{asset('themes/marketPlace/assets/img/shop_04.jpg')}}" alt="" class="img-fluid"></a>
              <h3 class="product-name mt-3">Product 4</h3>
              <div class="rating">
                <i class="bx bxs-star"></i>
                <i class="bx bxs-star"></i>
